...
function How({ eyebrow, title,
  p1kicker, p1title, p1window, p1body, p1f1k, p1f1v, p1f2k, p1f2v, p1f3k, p1f3v,
  p2kicker, p2title, p2window, p2body, p2f1k, p2f1v, p2f2k, p2f2v, p2f3k, p2f3v }) {
  return (
      ...
      <MainGrid>
        ...
        <div className="challenge-phases">
          <div className="challenge-phase challenge-phase-1">
            ...
            <h3 dangerouslySetInnerHTML={{ __html: p1title || "Make one trade. You're in." }} />
            ...
            <div className="challenge-phase-facts">
              ...
              <div className="challenge-phase-f"><div className="challenge-phase-fk">{p1f2k || "Pool"}</div><div className="challenge-phase-fv">{p1f2v || "$500"}</div></div>
              <div className="challenge-phase-f"><div className="challenge-phase-fk">{p1f3k || "Winners"}</div><div className="challenge-phase-fv">{p1f3v || "10"}</div></div>
            </div>
          </div>
          ...
          <div className="challenge-phase challenge-phase-2">
            ...
            <h3 dangerouslySetInnerHTML={{ __html: p2title || "Climb the board. Or stay lucky." }} />
            ...
            <div className="challenge-phase-facts">
              ...
              <div className="challenge-phase-f"><div className="challenge-phase-fk">{p2f3k || "Lucky"}</div><div className="challenge-phase-fv">{p2f3v || "10 × $50"}</div></div>
            </div>
          </div>
        </div>
      </MainGrid>
