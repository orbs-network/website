...
image: /assets/img/blog/getting-ready-for-round-iv-of-orbs-rewards-distribution/bg.jpg
blogUrl: getting-ready-for-round-iv-of-orbs-rewards-distribution
date: 2020-03-18
...
At the end of March 2020, the 4th round of rewards distribution will occur. This post describes the various rewards, how they are calculated and the distribution process.

### Rewards Distribution Process

- Rewards will be distributed at the end of March 2020.
- The rewards will be pushed to the recipients’ addresses on Ethereum.
- The rewards will comprise the accumulated rewards for each address (for all its relevant roles), up until (and including) the 110th elections, which will be based on Ethereum block number 9,708,900 ([https://etherscan.io/block/countdown/9,708,900](https://etherscan.io/block/countdown/9,708,900))
