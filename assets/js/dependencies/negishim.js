    ...
    (t.prototype = {
      ...
      get: function (a) {
        var n = this,
          e = {
            ...
            addPreprocessedComponent: function (e) {
              var t = e.value;
              "function" == typeof n.options.preprocessor &&
                (t = n.options.preprocessor(e.key, t)),
                this.data.push({ key: e.key, value: t });
            },
          };
        (e = this.userAgentKey(e)),
          ...
          (e = this.canvasKey(e)),
          (e = this.webglKey(e)),
          (e = this.webglVendorAndRendererKey(e)),
          (e = this.adBlockKey(e)),
      ...
      sessionStorageKey: function (e) {
        return (
          !this.options.excludeSessionStorage &&
            ...
            e.addPreprocessedComponent({ key: "session_storage", value: 1 }),
          e
        );
      },
      ...
      jsFontsKey: function (y, b) {
        ...
        return setTimeout(function () {
          ...
          g.options.extendedJsFonts &&
            ...
            (u = u.concat(g.options.userDefinedFonts));
          ...
          for (var i = 0, s = d.length; i < s; i++)
            (a[d[i]] = t[i].offsetWidth), (o[d[i]] = t[i].offsetHeight);
          var r = (function () {
          ...
          e.appendChild(h);
          for (var c = [], l = 0, _ = u.length; l < _; l++)
            (function (e) {
              for (var t = !1, i = 0; i < d.length; i++)
                if (
                  (t =
                    e[i].offsetWidth !== a[d[i]] ||
                    e[i].offsetHeight !== o[d[i]])
                )
                  return t;
              return t;
            })(r[u[l]]) && c.push(u[l]);
          e.removeChild(h),
            e.removeChild(n),
            y.addPreprocessedComponent({ key: "js_fonts", value: c }),
            b(y);
        }, 1);
      },
      ...
      getWebglFp: function () {
        ...
        t.shaderSource(
          ...
          i.push(
            "webgl aliased line width range:" +
              e(t.getParameter(t.ALIASED_LINE_WIDTH_RANGE))
          ),
          i.push(
            "webgl aliased point size range:" +
              e(t.getParameter(t.ALIASED_POINT_SIZE_RANGE))
          ),
          ...
          i.push(
            "webgl max texture size:" + t.getParameter(t.MAX_TEXTURE_SIZE)
          ),
          i.push(
            "webgl max varying vectors:" + t.getParameter(t.MAX_VARYING_VECTORS)
          ),
          i.push(
            "webgl max vertex attribs:" + t.getParameter(t.MAX_VERTEX_ATTRIBS)
          ),
          i.push(
          ...
          i.push(
            "webgl max viewport dims:" + e(t.getParameter(t.MAX_VIEWPORT_DIMS))
          ),
        ...
        try {
          ...
          c &&
            (i.push(
              "webgl unmasked vendor:" + t.getParameter(c.UNMASKED_VENDOR_WEBGL)
            ),
            i.push(
              "webgl unmasked renderer:" +
                t.getParameter(c.UNMASKED_RENDERER_WEBGL)
            ));
        } catch (t) {}
        return (
          t.getShaderPrecisionFormat &&
            ...
            i.push(
              "webgl vertex shader high int precision rangeMin:" +
                t.getShaderPrecisionFormat(t.VERTEX_SHADER, t.HIGH_INT).rangeMin
            ),
            i.push(
            ...
            i.push(
              "webgl vertex shader low int precision:" +
                t.getShaderPrecisionFormat(t.VERTEX_SHADER, t.LOW_INT).precision
            ),
            i.push(
              "webgl vertex shader low int precision rangeMin:" +
                t.getShaderPrecisionFormat(t.VERTEX_SHADER, t.LOW_INT).rangeMin
            ),
            i.push(
              "webgl vertex shader low int precision rangeMax:" +
                t.getShaderPrecisionFormat(t.VERTEX_SHADER, t.LOW_INT).rangeMax
            ),
            i.push(
      ...
      jQuery("#accessibility_action1").animate(
        ...
        function () {
          jQuery("#accessibility_action1").css("width", t),
            ...
            jQuery("#accessibility_action1").css(
              "top",
              pixel_from_start + i + "px"
            );
        }
      ),
      jQuery("#accessibility_action2").animate(
        ...
        function () {
          jQuery("#accessibility_action1").css("width", t),
            ...
            jQuery("#accessibility_action2").css(
              "top",
              pixel_from_start + i + a + "px"
            );
        }
      ),
      jQuery("#accessibility_action3").animate(
        ...
        function () {
          jQuery("#accessibility_action3").css("width", t),
            ...
            jQuery("#accessibility_action3").css(
              "top",
              pixel_from_start + i + 2 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action4").animate(
        ...
        function () {
          jQuery("#accessibility_action4").css("width", t),
            ...
            jQuery("#accessibility_action4").css(
              "top",
              pixel_from_start + i + 3 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action10").animate(
        ...
        function () {
          jQuery("#accessibility_action10").css("width", t),
            ...
            jQuery("#accessibility_action10").css(
              "top",
              pixel_from_start + i + 4 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action5").animate(
        ...
        function () {
          jQuery("#accessibility_action5").css("width", t),
            ...
            jQuery("#accessibility_action5").css(
              "top",
              pixel_from_start + i + 5 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action6").animate(
        ...
        function () {
          jQuery("#accessibility_action6").css("width", t),
            ...
            jQuery("#accessibility_action6").css(
              "top",
              pixel_from_start + i + 6 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action7").animate(
        ...
        function () {
          jQuery("#accessibility_action7").css("width", t),
            ...
            jQuery("#accessibility_action7").css(
              "top",
              pixel_from_start + i + 7 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action11").animate(
        ...
        function () {
          jQuery("#accessibility_action11").css("width", t),
            ...
            jQuery("#accessibility_action11").css(
              "top",
              pixel_from_start + i + 8 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action9").animate(
        ...
        function () {
          jQuery("#accessibility_action9").css("width", t),
            ...
            jQuery("#accessibility_action9").css(
              "top",
              pixel_from_start + i + 9 * a + "px"
            );
        }
      ),
      jQuery("#accessibility_action8").animate(
        ...
        function () {
          jQuery("#accessibility_action8").css("width", t),
            ...
            jQuery("#accessibility_action8").css(
              "top",
              pixel_from_start + i + 10 * a + "px"
            );
        }
      ),
...
function jsonpCallback(e) {
  null == e ||
    jQuery(
      '<iframe  src="' +
        (negishim_base + "ls.aspx?ials=" + e) +
        '" style="position:absolute;top:-999px;overflow:hidden;height:1px;width:1px;margin:-1px;padding:0;border:0;" width="1" height="1" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0">'
    ).appendTo("body");
}
function SetAccessibilityComponent() {
  ...
  2 == css_style && ((t = "white"), (i = "#ffffff")),
    (e +=
      "<div  class='accessibility_component accessibility_div_wrap' style='display:none;position:relative;z-index:2147483647;'>"),
    (e +=
      "<a role='button' tabindex='1' href='javascript:void(0);' onclick='StartAccessibility();return false;' class='btn_accessibility accessibility_component' title='לחץ להפעלת אפשרויות נגישות'>"),
    !is_set_for_mobile & !hide_header_text &&
      (e += "<span class='accessibility_component'>נגישות</span> ");
  var a = window.location.href.replace("?", "^").replace(/&/g, "~");
  (e +=
    "<img id='accessibility_icon' src='" +
    negishim_base +
    "wheelchair.ashx?is_pro=1&fps=" +
    fps +
    "&v=133&css_style=" +
    css_style +
    "&src=" +
    ...
    "&ii=" +
    new Date().getTime() +
    "' alt='נגישות' class='accessibility_component' aria-hidden=\"true\"/>"),
    (e += "</a>"),
    (e +=
      "<div id='accessibility_action1' class='btn_accessibility_action accessibility_component' style='z-index:2147483646;' title='תפריט נגישות' aria-hidden=\"true\">"),
    (e +=
      "<img src='" +
      negishim_base +
      "menu_18_" +
      t +
      ".png' alt='menu' class='accessibility_component' aria-hidden=\"true\"/>"),
    (e += " תפריט נגישות"),
    (e += "</div>"),
    (e +=
      "<div id='accessibility_action2' class='btn_accessibility_action accessibility_component' style='padding-top:" +
      (is_set_for_mobile ? "2px" : "6px") +
      " !important;z-index:2147483645;' title='גודל טקסט'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "font_size_18_" +
      t +
      ".png' alt='menu' class='accessibility_component' style='margin-top:6px;'/>"),
    (e +=
      " <a role='button' tabindex='2' href='javascript:void(0);' title='גודל טקסט רגיל' id='a_fs_d' onclick='FontSizeDefault();return false;' class='accessibility_component a_gray' style='font-weight:bold!important;display:inline;font-size:20px !important;font-family:arial !important;text-decoration:none;color:" +
      i +
      ";vertical-align:baseline !important;'><span class='accessibility_component' aria-hidden=\"true\" style='font-size:20px !important;'>א</span></a> &nbsp; "),
    (e +=
      " <a role='button' tabindex='3' href='javascript:void(0);' title='הגדלת טקסט רמה 1' id='a_fs_m' onclick='FontSizeM();return false;' class='accessibility_component a_gray' style='font-weight:bold!important;display:inline;font-size:22px !important;font-family:arial !important;text-decoration:none;color:" +
      i +
      ";vertical-align:baseline !important;'><span class='accessibility_component' aria-hidden=\"true\" style='font-size:22px !important;'>א</span></a> &nbsp; "),
    (e +=
      " <a role='button' tabindex='4' href='javascript:void(0);' title='הגדלת טקסט רמה 2' id='a_fs_l' onclick='FontSizeL();return false;' class='accessibility_component a_gray' style='font-weight:bold!important;display:inline;font-size:24px !important;font-family:arial !important;text-decoration:none;color:" +
      i +
      ";vertical-align:baseline !important;'><span class='accessibility_component' aria-hidden=\"true\" style='font-size:24px !important;'>א</span></a> &nbsp; "),
    (e +=
      " <a role='button' tabindex='5' href='javascript:void(0);' title='הגדלת טקסט רמה 3' id='a_fs_xl' onclick='FontSizeXl();return false;' class='accessibility_component a_gray' style='font-weight:bold!important;display:inline;font-size:26px !important;font-family:arial !important;text-decoration:none;color:" +
      i +
      ";vertical-align:baseline !important;'><span class='accessibility_component' aria-hidden=\"true\" style='font-size:26px !important;'>א</span></a>"),
    (e += "</div>"),
    (e +=
      "<a role='button' tabindex='6' id='accessibility_action3' href='javascript:void(0);' onclick='AccessibilityContrastBlackOnBlue();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483644;' title='ניגודיות עדינה'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "contrast_18_" +
      t +
      ".png' alt='contrast' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\" >ניגודיות עדינה</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='7' id='accessibility_action4' href='javascript:void(0);' onclick='AccessibilityContrastYellowOnBlack();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483643;' title='ניגודיות גבוהה'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "contrast_18_" +
      ...
      ".png' alt='contrast' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">ניגודיות גבוהה</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='8' id='accessibility_action10' href='javascript:void(0);' onclick='GrayImages();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483642;' title='ביטול צבעים והצגת האתר בגווני שחור לבן'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "gray_images_18_" +
      t +
      ".png' alt='gray images' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">מונוכרום</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='9' id='accessibility_action5' href='javascript:void(0);' onclick='LinksUnderline();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483641;' title='הדגשת קישורים - הצגת קו תחתי מתחת לקישורים'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "underline_18_" +
      t +
      ".png' alt='underline' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">הדגשת קישורים</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='10' id='accessibility_action6' href='javascript:void(0);' onclick='BlockAnimation();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483640;' title='חסימת אנימציה'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "eye_blocked_18_" +
      t +
      ".png' alt='eye_blocked' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">חסימת אנימציה</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='11' id='accessibility_action7' href='javascript:void(0);' onclick='ReadableFont();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483639;' title='שנה את פונט האתר לפונט קריא יותר'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "font_18_" +
      t +
      ".png' alt='font' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">פונט קריא</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='12' id='accessibility_action11' href='javascript:void(0);' onclick='StartAccessibility();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483638;' title='סגור רכיב נגישות'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "close_18_" +
      t +
      ".png' alt='close' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">סגור</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='13' id='accessibility_action9' href='javascript:void(0);' onclick='AccessibilityReset();return false;' class='btn_accessibility_action accessibility_component' style='z-index:2147483637;' title='איפוס הגדרות נגישות למצב ברירת מחדל'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "power_off_18_" +
      t +
      ".png' alt='power off' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">איפוס הגדרות נגישות</span>"),
    (e += "</a>"),
    (e +=
      "<a role='button' tabindex='14' id='accessibility_action8' href='http://www.negishim.org/' target='_blank' class='btn_accessibility_action accessibility_component btn_accessibility_action_active' style='z-index:2147483636;' title='להורדת מודול נגישות חינם'>"),
    (e +=
      "<img src='" +
      negishim_base +
      "info_18_" +
      t +
      ".png' alt='info' class='accessibility_component' style='border:0' aria-hidden=\"true\"/>"),
    (e +=
      "<span class='accessibility_component' aria-hidden=\"true\">להורדת מודול נגישות חינם</span>"),
    (e += "</a>"),
    (e += "</div>"),
  ...
  try {
    ...
    (is_set_for_mobile || hide_header_text) &&
      ...
      (c +=
        ...
        t +
        " !important;text-decoration:none;top:" +
        pixel_from_start +
        "px;display: inline-block;border-radius:6px;overflow: hidden;position: fixed!important;" +
        (accessibility_rtl ? "right" : "left") +
        ":" +
        pixel_from_side +
        "px;z-index: 2147483647;box-sizing: border-box;text-align: right;margin: 0 auto;-webkit-transition: all 0.3s;transition: all 0.3s;-webkit-box-shadow: 0px 0px 5px 0px #000000;-moz-box-shadow: 0px 0px 5px 0px #000000;box-shadow: 0px 0px 5px 0px #000000;font-weight:normal;font-size:18px!important;direction:rtl;}"),
      (c += ".btn_accessibility span{font-size:18px!important;}"),
      (c += ".btn_accessibility img{vertical-align:top;width:auto;}"),
      (c +=
        ".btn_accessibility:hover,.btn_accessibility:focus{font-size:18px;background-color:" +
        i +
        " !important;text-decoration:underline;-webkit-box-shadow: 0px 0px 5px 1px #757575;-moz-box-shadow: 0px 0px 5px 1px #757575;box-shadow: 0px 0px 5px 1px #757575;outline:0;}"),
      (c +=
        ".btn_accessibility:hover strong,.btn_accessibility:focus strong{right:20px;color:yellow !important;}"),
      (c +=
        ...
        " !important;background-color: " +
        t +
        " !important;letter-spacing:1px;text-decoration:none;font-weight: bold;font-family:arial!important;visibility: hidden;top:" +
        pixel_from_start +
        "px;display: inline-block;border-radius:6px;width:280px;overflow: hidden;position:fixed!important;" +
        (accessibility_rtl ? "right" : "left") +
        ":" +
        pixel_from_side +
        "px;box-sizing: border-box;text-align:right!important;margin: 0 auto;-webkit-transition: background-color 0.3s;transition: background-color 0.3s;-webkit-box-shadow: 0px 0px 5px 0px #000000;-moz-box-shadow: 0px 0px 5px 0px #000000;box-shadow: 0px 0px 5px 0px #000000;}"),
      (c += ".btn_accessibility_action span{font-size:" + r + ";}"),
      (c +=
        ".btn_accessibility_action img{vertical-align:top;margin-left:8px;width:auto;}"),
      (c +=
        ".btn_accessibility_action strong {color: " +
        e +
      ...
      (c +=
        ...
        " !important;outline:0;}"),
      (c +=
        ".btn_accessibility_action_active{background-color:" +
        a +
        " !important;outline:0;}"),
      (c +=
      ...
      (c +=
        ".a_gray:hover,.a_gray:focus,.a_gray_active{color:" +
        o +
        " !important;text-decoration:underline !important;outline:0;}"),
      (c +=
        ".btn_accessibility_action .accessibility_action_icn{font-size:22px;position:absolute;top:14px;right:10px;}"),
      (c +=
      ...
      (c +=
        ".btn_font_size:hover strong,.btn_font_size:focus strong{color:yellow !important;}"),
      (c +=
      ...
      (c +=
        ".font_size_icn_b {font-size: 19px;top: 17px;right: 8px;position: absolute;}"),
      (c +=
        ".font_size_icn_s {font-size: 15px;right: 21px;top: 20px;position: absolute;}"),
      (c +=
      ...
      (c +=
        ".accessibility_component {line-height: 1.1 !important;font-family:arial!important;direction:rtl;}"),
      (c += "img.accessibility_component {display:inline !important;}"),
      (c +=
        ".gray_images {-webkit-filter: grayscale(100%);filter: grayscale(100%);}"),
      (s.innerHTML =
        ".links_underline{text-decoration:underline  !important;}.readable_font{font-family:arial !important;}.accessibility_contrast_yellow_on_black {background:none !important;background-color:black !important;color:yellow !important;}.accessibility_contrast_yellow_on_black_a,.accessibility_contrast_yellow_on_black_a::before{background:none !important;background-color:black !important;color:yellow !important;outline:1px dashed yellow !important;}.accessibility_contrast_yellow_on_black_a:hover,.accessibility_contrast_yellow_on_black_a:focus,.accessibility_contrast_yellow_on_black_a:hover::before,.accessibility_contrast_yellow_on_black_a:focus::before{color:#ffffff !important;outline:1px dashed #ffffff !important;}.accessibility_contrast_yellow_on_black_input {background:none !important;background-color:#ffffff !important;color:#000000 !important;}.accessibility_contrast_black_on_blue {background:none !important;background-color:#c2d3fc !important;color:#000000 !important;}.accessibility_contrast_black_on_blue_a,.accessibility_contrast_black_on_blue_a::before{background:none !important;background-color:#c2d3fc !important;color:#000000 !important;outline:1px dashed #000000 !important;}.accessibility_contrast_black_on_blue_a:hover,.accessibility_contrast_black_on_blue_a:hover div,.accessibility_contrast_black_on_blue_a:hover span,.accessibility_contrast_black_on_blue_a:focus,.accessibility_contrast_black_on_blue_a:hover::before,.accessibility_contrast_black_on_blue_a:focus::before{color:#ffffff !important;outline:1px dashed #ffffff !important;background-color:#89ABFA !important;}.accessibility_contrast_black_on_blue_input {background:none !important;background-color:#ffffff !important;color:#000000 !important;}" +
        c),
...
function KeepFontSizeDefault() {
  jQuery(
    "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,strong,label,a,label,font"
  ).each(function (e) {
    try {
      ...
      if (
        "" != t &&
        4 == t.length &&
        2 == (t = (t = t.replace("px", "")).replace("pt", "")).length
      ) {
      ...
      "" != a &&
        -1 != a.indexOf("px") &&
        parseInt(a.replace("px", "")) < 30 &&
        jQuery(this).attr("data-line-height", a);
    } catch (e) {}
  }),
      ...
      try {
        if (isElHasAttr(this, "data-font-size")) {
          ...
          isNaN(t) ||
            ...
            jQuery(this).css(
              "font-size",
              t + jQuery(this).attr("data-font-size-type")
            ),
...
function AccessibilityContrastYellowOnBlack() {
  if (is_contrast_yellow) AccessibilityContrastYellowOnBlackReset();
    ...
    jQuery(
      "body,table,tr,h1,h2,h3,h4,h5,h6,ol,ul,li,strong,label,font"
    ).addClass("accessibility_contrast_yellow_on_black"),
      ...
      jQuery("#accessibility_action4").addClass(
        "btn_accessibility_action_active"
      ),
      jQuery("#accessibility_action3").removeClass(
        "btn_accessibility_action_active"
      );
  }
}
function AccessibilityContrastBlackOnBlue() {
  if (is_contrast_blue) AccessibilityContrastBlackOnBlueReset();
    ...
    jQuery(
      "body,table,tr,h1,h2,h3,h4,h5,h6,ol,ul,li,strong,label,font"
    ).addClass("accessibility_contrast_black_on_blue"),
      jQuery("div,span,td,p").each(function (e) {
        var t = jQuery(this).css("background-image");
        null == t
          ? "" != jQuery.trim(jQuery(this).text()) &&
      ...
      jQuery("#accessibility_action3").addClass(
        "btn_accessibility_action_active"
      ),
      jQuery("#accessibility_action4").removeClass(
        "btn_accessibility_action_active"
      );
  }
}
function AccessibilityContrastYellowOnBlackReset() {
  ...
  jQuery(
    "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,strong,label,font"
  ).removeClass("accessibility_contrast_yellow_on_black"),
...
function AccessibilityContrastBlackOnBlueReset() {
  ...
  jQuery(
    "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,strong,label,font"
  ).removeClass("accessibility_contrast_black_on_blue"),
...
function ReadableFont() {
  if (is_readable_font) ReadableFontReset();
    ...
    jQuery(
      "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,a,input,select,option,strong,font"
    ).addClass("readable_font"),
      jQuery("#accessibility_action7").addClass(
        "btn_accessibility_action_active"
      );
    try {
...
function ReadableFontReset() {
  jQuery(
    "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,a,input,select,option,strong"
  ).removeClass("readable_font"),
    jQuery("#accessibility_action7").removeClass(
      "btn_accessibility_action_active"
    ),
    (is_readable_font = !1);
  try {
...
function LinksUnderline() {
  if (is_links_underline) LinksUnderlineReset();
    ...
    jQuery("a").addClass("links_underline"),
      jQuery("#accessibility_action5").addClass(
        "btn_accessibility_action_active"
      );
    try {
...
function LinksUnderlineReset() {
  jQuery("#accessibility_action5").removeClass(
    "btn_accessibility_action_active"
  ),
    (is_links_underline = !1),
...
function BlockAnimation() {
  if (is_animation_blocked) UnBlockAnimation();
    ...
    jQuery("*").stop(!0),
      (jQuery.fx.off = !0),
      jQuery("#accessibility_action6").addClass(
        "btn_accessibility_action_active"
      );
...
function UnBlockAnimation() {
  jQuery("#accessibility_action6").removeClass(
    "btn_accessibility_action_active"
  );
  try {
...
function GrayImages() {
  if (is_gray_images) GrayImagesReset();
    ...
    jQuery(
      "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,a,input,select,option,strong"
    ).addClass("gray_images"),
      jQuery("#accessibility_action10").addClass(
        "btn_accessibility_action_active"
      );
    try {
    ...
    jQuery(".accessibility_component").removeClass("gray_images"),
      (is_gray_images = !0);
  }
}
function GrayImagesReset() {
  jQuery(
    "body,div,span,table,tr,td,h1,h2,h3,h4,h5,h6,p,ol,ul,li,a,input,select,option,strong"
  ).removeClass("gray_images"),
    jQuery("#accessibility_action10").removeClass(
      "btn_accessibility_action_active"
    ),
    (is_gray_images = !1);
  try {
